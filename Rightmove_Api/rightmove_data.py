...
class RightmoveData:
    ...
    def results_count_display(self):
        ...
        xpath = """//div[contains(@class, "ResultsCount_resultsCount")]/p/span/text()"""
    ...
    def _get_page(self, request_content: str, get_floorplans: bool = False):
        ...
        xp_beds = '//span[contains(@class, "PropertyInformation_bedroomsCount")]/text()'
        xp_added = '//span[contains(@class, "MarketedBy_addedOrReduced")]/text()'
        xp_type = '//span[contains(@class, "PropertyInformation_propertyType")]/text()'
        xp_weblinks = '//a[@data-test="property-details"]/@href'
        

        # Create data lists from xpaths:
        titles = tree.xpath(xp_addresses)
        price_pcm = tree.xpath(xp_prices)
        beds = tree.xpath(xp_beds)
        added = tree.xpath(xp_added)
        property_type = tree.xpath(xp_type)
        ...
        data = [titles, weblinks, price_pcm, beds, added, property_type]
